...
<body class="min-h-screen flex flex-col bg-gradient-to-br from-indigo-500 to-purple-600">
    ...
    <nav class="bg-white bg-opacity-95 shadow-lg py-4 px-8 flex items-center justify-between border-b-4 border-blue-200">
        ...
        <div>
            <a href="/login" class="bg-gradient-to-r from-blue-700 to-red-700 text-white px-6 py-2 rounded-lg font-bold shadow hover:from-blue-900 hover:to-red-800 transition">Login</a>
        </div>
    </nav>
    <!-- Hero Section -->
    <main class="flex-1 flex flex-col items-center justify-center text-center px-4">
        ...
        <a href="/signup" class="inline-block bg-gradient-to-r from-blue-700 to-red-700 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:from-blue-900 hover:to-red-800 transition">Get Started</a>
