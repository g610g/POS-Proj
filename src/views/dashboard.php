    ...
    <main class="flex-1 flex flex-col items-center justify-center p-8">
        <div class="w-full max-w-4xl grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            <div class="bg-white bg-opacity-90 rounded-2xl shadow-xl p-8 flex flex-col items-center hover:scale-105 transition">
                ...
                <a href="/sales" class="mt-4 bg-gradient-to-r from-blue-700 to-red-700 text-white px-6 py-2 rounded-lg font-bold shadow hover:from-blue-900 hover:to-red-800 transition text-center">New Sale</a>
            </div>
            <div class="bg-white bg-opacity-90 rounded-2xl shadow-xl p-8 flex flex-col items-center hover:scale-105 transition">
        ...
        <div class="w-full max-w-4xl mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-white bg-opacity-90 rounded-2xl shadow-xl p-8 flex flex-col items-center hover:scale-105 transition">
                ...
                <p class="text-3xl font-extrabold text-indigo-600"><?php echo htmlspecialchars($todaySales) ?></p>
            </div>
            <div class="bg-white bg-opacity-90 rounded-2xl shadow-xl p-8 flex flex-col items-center hover:scale-105 transition">
